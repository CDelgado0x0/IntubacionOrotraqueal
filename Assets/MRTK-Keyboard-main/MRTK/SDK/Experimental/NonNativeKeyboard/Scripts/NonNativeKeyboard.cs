...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    public class NonNativeKeyboard : MonoBehaviour
    {
        ...
        /// <summary>
        /// References tildes keyboard panel.
        /// </summary>
        public Image TildesKeyboard = null;
        ...
        /// </summary>
        /// 
        [SerializeField] private ShowKeyboard keyboardBehaviour;
        void Awake()
        {
            Instance = this;
            ...
            keyboardBehaviour.CloseKeyboard();
        }
        ...
        public void FunctionKey(KeyboardKeyFunc functionKey)
        {
            ...
            switch (functionKey.ButtonFunction)
            {
                ...
                case KeyboardKeyFunc.Function.Tildes:
                {
                    Tildes();
                    break;
                }
        ...
        /// <summary>
        /// Set the keyboard to a Tildes state.
        /// </summary>
        public void Tildes()
        {
            // Oculta todos los teclados
            DisableAllKeyboards();

            // Muestra el teclado de tildes
            if (TildesKeyboard != null)
            {
                TildesKeyboard.gameObject.SetActive(true);
            }
        }
        ...
        private void DisableAllKeyboards()
        {
            ...
            TildesKeyboard.gameObject.SetActive(false);
        }
